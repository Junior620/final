...
urlpatterns = [
    ...
    path('dev-web-mobile/creation-site-web', views.creation_site_web, name="creation-site-web"),
    path('dev-web-mobile/creation-site-web/formulaire-wordpress', views.formulaire_wordpress, name="formulaire-wordpress"),
    path('dev-web-mobile/creation-site-web/formulaire-vitrine', views.formulaire_vitrine, name="formulaire-vitrine"),
    path('dev-web-mobile/creation-site-web/formulaire-e-commerce', views.formulaire_e_commerce, name="formulaire-e-commerce"),
